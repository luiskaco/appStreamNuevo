...
<div class="container-button-soporte">
    <button type="button" class="btn  custom-button-soporte font-weight-bold text-white" data-toggle="modal" data-target="#modalAddComment">
        ...
        <div class="modal-content-soporte">
            ...
            <div class="modal-body">
                ...
                <div class="container-button-whatsapp" >
                    ...
                    class="btn custom-button-soporte font-weight-bold text-white"
                    style="background: #49BA39;">
                    <i class="fas fa-whatsapp" aria-hidden="true"></i>
                    Contáctanos por WhatsApp</a>
                </div>
            </div>
        </div>
 <!-- <input class="comments-input" type="text" placeholder="Añade un comentario..."/> btn  custom-button-encuesta font-weight-bold text-white-->
        <!-- <div class="instagram-card-footer">

      <input class="comments-input" type="text" placeholder="Añade un comentario..."/>
      <button type="button" class="btn btn-comment" href="#"> Enviar </button>
    </div>
